...
namespace Client.Blazor.Auth.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var webapiResult = await SignInWebApi(Input.Email, Input.Password);

                if (result.Succeeded && webapiResult)
                {
        ...
        private async Task<bool> SignInWebApi(string email, string password)
        {
            try
            {
